...
Entropy v1.0.2 uses the compatibility identity `entropy-mainnet-v1`. The word
...
- Network privacy is not a goal of v1.0.2. Peers observe IP addresses, timing, and

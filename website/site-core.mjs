export const FALLBACK_RELEASE_URL = "https://github.com/HONG-LOU/entcoin/releases/tag/v1.0.7";
...
const en = {
  ...
  "download.boundary": "v1.0.7 is unsigned and may trigger SmartScreen. Verify the published checksums and understand their limits.",
...
const zh = {
  ...
  "download.boundary": "v1.0.7 尚未签名，可能触发 SmartScreen。请核对发布的 SHA-256 校验值，并了解校验值不能证明发布者身份。",
  ...
  "security.label": "开放网络",
  "security.body": "两个位于不同区域的公共归档种子让 Entcoin 能够通过互联网持续连接。每个桌面节点都会独立验证链，也可以自动发现同一局域网内的节点。",

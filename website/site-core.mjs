export const FALLBACK_RELEASE_URL = "https://github.com/HONG-LOU/entcoin/releases/tag/v1.0.8";
...
const en = {
  ...
  "download.boundary": "v1.0.8 is unsigned and may trigger SmartScreen. Verify the published checksums and understand their limits.",
...
const zh = {
  ...
  "download.boundary": "v1.0.8 尚未签名，可能触发 SmartScreen。请核对发布的 SHA-256 校验值，并了解校验值不能证明发布者身份。",
